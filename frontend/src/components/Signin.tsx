...
import { signinType } from "@abhie.npm/blogbuddy-common"
...
export const Signin = () => {
    ...
    const sendSignInDeatailsToServer = async () =>{
        setLoading(true);
        const payload = postInputs;
        try{
            const response = await axios.post(API_BASE_URL+'/api/v1/user/signin', payload)
              ...
              <div className="flex justify-center">
                  <div className=" shadow-2xl p-12">
                     <div className="px-10">
                      ...
                      <button onClick={sendSignInDeatailsToServer} 
                              type="button" 
